...
## 2. Setting up an instance with the EC2 Management Console <a href="#id-2-setting-up-an-instance-with-the-ec2-management-console" id="id-2-setting-up-an-instance-with-the-ec2-management-console"></a>
...
## 3. Configuring the server via RDP (Remote Desktop) <a href="#id-3-configuring-the-server-via-rdp-remote-desktop" id="id-3-configuring-the-server-via-rdp-remote-desktop"></a>
...
## 4. Testing the connection <a href="#id-4-testing-the-connection" id="id-4-testing-the-connection"></a>
